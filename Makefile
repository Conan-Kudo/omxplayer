...
LDFLAGS+=-L./ -L/usr/lib/ -lc -lWFC -lGLESv2 -lEGL -lbcm_host -lopenmaxil -lfreetype -lz -lasound

INCLUDES+=-I./ -Ilinux -I/usr/include/ffmpeg -I /usr/include/dbus-1.0 -I /usr/lib/dbus-1.0/include
